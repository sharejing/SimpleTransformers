...
def data_config(parser):
    parser.add_argument("--trainset_path", type=str, default="data/Chinese_Spam_Message/train.txt",
                        help="训练集路径")
...
def model_config(parser):
    ...
    parser.add_argument("--model_name", type=str, default="bert-base-chinese",
                        help="选择使用哪个预训练模型")
    parser.add_argument("--manual_seed", type=int, default=624,
...
def train_config(parser):
    ...
    parser.add_argument("--num_train_epochs", type=int, default=3,
                        help="模型训练迭代数")
    parser.add_argument("--evaluate_during_training_steps", type=int, default=500,
                        help="在每个指定的step上执行评估，checkpoint和评估结果将被保存")
    parser.add_argument("--wandb_project", type=str, default="Chinese_Message_Classification",
